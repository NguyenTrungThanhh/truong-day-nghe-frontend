...
function KhoaHocLaiXeOToHangBSoTuDong() {
    const swiperRef = useRef(null);

    useEffect(() => {
        document.title = 'Khóa học lái xe ô tô hạng B (số tự động)';
    });
            ...
            <div className="w-full bg-[#f4f4f4] py-4">
                <div className="w-[90%] lg:w-[80%] mx-auto">
                    <div className="flex items-center gap-4 text-sm font-medium">
                        ...
                        <h1 className="text-primary-blueOne">Khóa học lái xe ô tô hạng B (số tự động)</h1>
                    </div>
                </div>
            </div>
                ...
                <div className="w-[90%] lg:w-[80%] mx-auto">
                    <div className="flex flex-col lg:flex-row justify-center items-center gap-4 mb-8 text-center">
                        ...
                        <h1 className="text-2xl font-bold text-white uppercase">
                            Nội dung khóa học lái xe hạng B (số tự động)
                        </h1>
                        <hr className="hidden lg:block w-[23%] border-white" />
                    </div>
            ...
            <div className="w-[90%] lg:w-[80%] mx-auto py-16">
                <div className="flex justify-center items-center gap-4 mb-8">
                    ...
                    <h1 className="text-2xl font-bold text-primary-blueOne uppercase text-center">
                        5 sai lầm thường gặp khi học lái xe ô tô hạng B (số tự động)
                    </h1>
                    <hr className="hidden lg:block w-[15%] border-t-[1px] border-primary-blueOne" />
                </div>
                ...
                <div className="w-[90%] lg:w-[80%] mx-auto">
                    <div className="flex justify-center items-center gap-4 mb-16">
                        ...
                        <h1 className="text-2xl font-bold text-white uppercase text-center">
                            Ưu điểm khi học lái xe ô tô hạng B (số tự động) tại Trung tâm Đào tạo Lái xe - Công ty Cổ
            ...
            <div className="w-full bg-primary-blueOne py-16">
                <div className="w-[90%] lg:w-[80%] mx-auto">
                    <div className="flex flex-col sm:flex-row justify-center items-center gap-4 mb-8 text-center">
                        ...
                        <h1 className="text-2xl font-bold text-white uppercase">
                            Nội dung khóa học lái xe hạng B (số tự động) tại Trung tâm Đào tạo Lái xe
                            <br className="sm:hidden" /> - Công ty Cổ phần Vận tải Ô tô số 4
                        </h1>
                        <hr className="hidden sm:block w-[19%] border-white" />
                    </div>
                    <p className="text-center text-white mb-8 px-2">
                        Giáo trình giảng dạy bám sát nội dung 11 bài thi lái xe Ô tô hạng B (số tự động) với mong muốn
...
export default KhoaHocLaiXeOToHangBSoTuDong;
