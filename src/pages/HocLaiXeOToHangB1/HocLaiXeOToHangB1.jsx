                    ...
                    <div className="flex items-center gap-4">
                        <div className="w-1/2">
                            <div className="flex flex-col gap-4 text-white">
                                <h1 className="text-xl font-bold">Đưa chương trình thi vào đào tạo</h1>
                                <p>
                                ...
                                <h1 className="text-xl font-bold">Đội ngũ hỗ trợ</h1>
                                <p>
                                ...
                                <h1 className="text-xl font-bold">Không chỉ là học để thi</h1>
                                <p>
