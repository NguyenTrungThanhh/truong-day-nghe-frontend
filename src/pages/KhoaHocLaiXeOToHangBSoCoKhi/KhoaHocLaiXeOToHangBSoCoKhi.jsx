...
function KhoaHocLaiXeOToHangBSoCoKhi() {
    const swiperRef = useRef(null);

    useEffect(() => {
        document.title = 'Khóa học lái xe ô tô hạng B (số cơ khí)';
    });
        ...
        <>
            <div className="w-full bg-[#f4f4f4] py-4">
                <div className="w-[90%] lg:w-[80%] mx-auto">
                    <div className="flex items-center gap-4 text-sm font-medium">
                        ...
                        <h1 className="text-primary-blueOne">Khóa học lái xe ô tô hạng B (số cơ khí)</h1>
                    </div>
                </div>
            </div>
                ...
                <div className="w-[90%] lg:w-[80%] mx-auto">
                    <div className="flex flex-col lg:flex-row justify-center items-center gap-4 mb-8 text-center">
                        ...
                        <h1 className="text-2xl font-bold text-white uppercase">
                            Nội dung khóa học lái xe hạng B (số cơ khí)
                        </h1>
                        <hr className="hidden lg:block w-[25%] border-white" />
                    </div>
                    <p className="text-center text-white mb-8">
                        Giáo trình bám sát nội dung sát hạch cho hạng B (số cơ khí), nhằm đảm bảo tỉ lệ đạt cao nhất.
                    </p>
                    ...
                    <div className="bg-white p-6 rounded-lg">
                            ...
                            <table className="min-w-full text-sm text-left">
                                ...
                                <tbody className="text-gray-700">
                                    <tr>
                                        ...
                                        <td className="border px-4 py-2 text-center">41 giờ (~290 km)</td>
                                    </tr>
                                    <tr>
                                        <td className="border px-4 py-2">2</td>
                                        <td className="border px-4 py-2">Thực hành lái xe trên đường giao thông</td>
                                        <td className="border px-4 py-2 text-center">40 giờ (~810 km)</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr className="bg-gray-50 font-semibold">
                                        ...
                                        <td className="border px-4 py-2 text-center">83 giờ</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                        ...
                        <p className="mb-4">
                            <span className="font-semibold">235 giờ</span> (152 giờ lý thuyết + 83 giờ thực hành), tương
            ...
            <div className="w-[90%] lg:w-[80%] mx-auto py-16">
                <div className="flex justify-center items-center gap-4 mb-8">
                    <hr className="hidden lg:block w-[16%] border-t-[1px] border-primary-blueOne" />
                    <h1 className="text-2xl font-bold text-primary-blueOne uppercase text-center">
                        5 sai lầm thường gặp khi học lái xe ô tô hạng B (số cơ khí)
                    </h1>
                    <hr className="hidden lg:block w-[16%] border-t-[1px] border-primary-blueOne" />
                </div>
                ...
                <div className="flex flex-col lg:flex-row gap-4">
                    <div className="w-full lg:w-1/2">
                        <div>
                            <img src={assets.toyotaVios} alt="" className="rounded-lg" />
                        </div>
                    </div>
                ...
                <div className="w-[90%] lg:w-[80%] mx-auto">
                    <div className="flex justify-center items-center gap-4 mb-16">
                        ...
                        <h1 className="text-2xl font-bold text-white uppercase text-center">
                            Ưu điểm khi học lái xe ô tô hạng B (số cơ khí) tại Trung tâm Đào tạo Lái xe - Công ty Cổ
            ...
            <div className="w-[90%] lg:w-[80%] mx-auto py-16">
                <div className="flex justify-center items-center gap-4 mb-8">
                    ...
                    <h1 className="text-2xl font-bold text-primary-blueOne uppercase text-center">
                        Lợi ích sau khóa học lái xe ô tô hạng B (số cơ khí)
                    </h1>
                    <hr className="hidden lg:block w-[26%] border-t-[1px] border-primary-blueOne" />
                </div>
...
export default KhoaHocLaiXeOToHangBSoCoKhi;
