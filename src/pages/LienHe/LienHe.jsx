            ...
            <div className="w-[90%] lg:w-[80%] mx-auto my-8">
                <div className="flex flex-col lg:flex-row gap-8">
                    ...
                    <div className="w-full lg:w-1/2 flex flex-col gap-3">
                        ...
                        {/* Contact info */}
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-4 p-1 mb-6">
                            {/* Address */}
                            <div className="flex items-start gap-2">
                                <div className="w-10 h-10 border border-primary-blueOne rounded-full flex items-center justify-center shrink-0">
                        ...
                        <div className="flex flex-col gap-3">
                            ...
                            <form className="flex flex-col gap-3">
                                ...
                                <button
                                    type="submit"
                                    className="w-fit px-6 py-2 bg-primary-blueOne rounded-full text-sm text-white hover:bg-primary-blueTwo duration-300"
                                >
                                    Gửi thông tin
                                </button>
                            </form>
                    ...
                    <div className="w-full lg:w-1/2">
                        <div className="w-full h-[300px] sm:h-[400px] md:h-[500px] lg:h-[608px]">
                            <iframe
