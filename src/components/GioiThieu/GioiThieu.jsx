            ...
            <div className="w-[80%] mx-auto flex gap-8">
                ...
                <div className="w-[35%]">
                    <div className="uppercase text-2xl font-bold leading-tight">
                        <span className="text-[60px] text-green-700">10 năm </span>
                        <span className="text-primary-blueOne">đào tạo</span>
                        <p className="text-[28px] text-primary-blueOne mt-2">LÁI XE Ô TÔ – HỌC LÁI XE Ô TÔ HẠNG B2</p>
                    </div>
                ...
                <div className="w-[65%] grid grid-cols-2 gap-6">
                    <div className="flex flex-col items-center border border-primary-blueOne p-4 bg-white rounded-lg shadow-sm">
                        ...
                        <h3 className="text-primary-blueOne font-bold mb-2 text-lg">SÂN TẬP RIÊNG</h3>
                        <p className="text-[#333] leading-snug text-center">
                            LOD sở hữu 45000m2 sân tập đạt tiêu chuẩn ISO 9001:2015. Học viên được học trực tiếp trên
                            sân thi – xe thi.
                        </p>
                    </div>
                    <div className="flex flex-col items-center border border-primary-blueOne p-4 bg-white rounded-lg shadow-sm">
